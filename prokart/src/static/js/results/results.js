import {getById, openRequest} from '../utils.js';
...
function prepareEventsResults() {
    getById("finish-button").onclick = function () {
...
window.addEventListener('load', prepareEventsResults);
